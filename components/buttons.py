...
class button:
    ...
    def go(self):
        ...
        self.load_track = shapes.BorderedRectangle(0, 60, 150, 40, color=(20, 200, 20), border_color=(200, 20, 20), batch=self.buttono)
        ...
        self.button_load_track = text.Label('load truck', font_name='Times New Roman', font_size=16, x=10, y=75, batch=self.buttono, color=(255, 255, 255, 255))
