...
class button:
    ...
    # plot_scores=shapes.BorderedRectangle(0, 140, 150,  40, color=(20, 200, 20),border_color=(200,20,20),batch=button)
    # driving=shapes.BorderedRectangle(0, 100, 150,  40, color=(20, 200, 20),border_color=(200,20,20),batch=button)
    # loadtruck=shapes.BorderedRectangle(0, 60, 150,  40, color=(20, 200, 20),border_color=(200,20,20),batch=button)
    ...
    # plot_scores.opacity=150
    # driving.opacity=150
    # loadtruck.opacity=150
    ...
    # plot_learn_label=text.Label('show learning',font_name='Times New Roman',font_size=16,x=10, y=195,batch=button,color=(255,255,255,255))
    # plot_learn_label=text.Label('show scores',font_name='Times New Roman',font_size=16,x=10, y=155,batch=button,color=(255,255,255,255))
    # manual_label=text.Label('Manual : off',font_name='Times New Roman',font_size=16,x=10, y=115,batch=button,color=(255,255,255,255))
    # loadtrucklabel=text.Label('load truck',font_name='Times New Roman',font_size=16,x=10, y=75,batch=button,color=(255,255,255,255))
