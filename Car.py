...
class Set_car:
    ...
    [shapes.Line(Carx                 , Cary+image.height/4,Carx+500*cos( 90*pi/180) , Cary+500*sin( 90*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx-90 , Cary+10, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=485,batch=car)],
    [shapes.Line(Carx-1/4*image.width , Cary+image.height/4,Carx+500*cos(108*pi/180) , Cary+500*sin(108*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx-90 , Cary-10, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=470,batch=car)],
    [shapes.Line(Carx-2/4*image.width , Cary+image.height/4,Carx+500*cos(126*pi/180) , Cary+500*sin(126*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx-60 , Cary+60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=455,batch=car)],
    [shapes.Line(Carx-3/4*image.width , Cary+image.height/4,Carx+500*cos(144*pi/180) , Cary+500*sin(144*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx-60 , Cary-60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=440,batch=car)],
    [shapes.Line(Carx-image.width     , Cary+image.height/4,Carx+500*cos(162*pi/180) , Cary+500*sin(162*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+90 , Cary+10, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=425,batch=car)],
    [shapes.Line(Carx-image.width     , Cary               ,Carx+500*cos(180*pi/180) , Cary+500*sin(180*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+90 , Cary-10, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=410,batch=car)],
    [shapes.Line(Carx-image.width     , Cary-image.height/4,Carx+500*cos(198*pi/180) , Cary+500*sin(198*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+60 , Cary+60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=395,batch=car)],
    [shapes.Line(Carx-3/4*image.width , Cary-image.height/4,Carx+500*cos(216*pi/180) , Cary+500*sin(216*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+60 , Cary-60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=380,batch=car)],
    [shapes.Line(Carx-2/4*image.width , Cary-image.height/4,Carx+500*cos(234*pi/180) , Cary+500*sin(234*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+ 5 , Cary+60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=365,batch=car)],
    [shapes.Line(Carx-1/4*image.width , Cary-image.height/4,Carx+500*cos(252*pi/180) , Cary+500*sin(252*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+ 5 , Cary-60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=350,batch=car)],
    [shapes.Line(Carx                 , Cary-image.height/4,Carx+500*cos(270*pi/180) , Cary+500*sin(270*pi/180),width=1, color=(255,255,255), batch=car),shapes.Circle(Carx+ 5 , Cary-60, 3, color=(50, 225, 30), batch=car),True,text.Label('',font_name='Times New Roman',font_size=15,x=930, y=335,batch=car)]
